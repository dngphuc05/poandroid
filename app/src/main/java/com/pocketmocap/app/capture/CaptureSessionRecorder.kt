    ...
    private fun recordMetrics(
        ...
        metricsWriter?.appendLine(
            (
                ...
                scene?.lateralOffsetMeters,
                tracking?.source,
                tracking?.trackingState,
                tracking?.confidence,
                tracking?.hasGroundPlane,
                tracking?.rawCameraHeightMeters,
                tracking?.floorSource,
                tracking?.floorLockState,
                tracking?.cameraPosition?.getOrNull(0),
                tracking?.cameraPosition?.getOrNull(1),
                tracking?.cameraPosition?.getOrNull(2),
                tracking?.groundPoint?.getOrNull(0),
                tracking?.groundPoint?.getOrNull(1),
                tracking?.groundPoint?.getOrNull(2),
                technicalSource,
                serverStableFrames,
                acceptedPoseSource,
                serverPoseStatus,
                ...
                scene?.floorSource,
                scene?.solverConfidence,
                scene?.solverResidualMeters,
                scene?.floorHeightBiasMeters,
                scene?.depthScale,
                scene?.depthOffsetMeters,
                scene?.heightEndpointBiasMeters,
                scene?.heightLockState,
                scene?.distanceCandidateSpreadMeters,
                scene?.heightCandidateSpreadMeters,
                scene?.rawHipDepthDistanceMeters,
                scene?.footPlaneDistanceMeters,
                scene?.roiDistanceMeters,
                scene?.leftFootRayFloorDistanceMeters,
                scene?.rightFootRayFloorDistanceMeters,
                scene?.feetMidpointFloorDistanceMeters,
                scene?.nearestFootFloorDistanceMeters,
                scene?.footRayFloorSpreadMeters,
                scene?.topRayHeightMeters,
                scene?.topRayFloorHeightMeters,
                scene?.visualTopScanYNorm,
                scene?.visualTopScanConfidence,
                scene?.visualTopLiftNorm,
                scene?.pixelSpanHeightMeters,
                scene?.rootHipRayFloorDistanceMeters,
                scene?.distanceHeightGeometryResidualMeters,
                scene?.activeFactors,
                scene?.hipGeometryDistanceMeters,
                scene?.hipGeometryHeightMeters,
                scene?.torsoHeightMeters,
                scene?.torsoResidualMeters,
                scene?.groundedFootDistanceMeters,
                scene?.footContactState,
                scene?.boneLengthSpreadMeters,
                scene?.bodyScaleConfidence,
                scene?.distanceConfidence,
                scene?.heightConfidence,
                scene?.floorConfidence,
                scene?.distanceState,
                scene?.weightHip,
                scene?.weightHead,
                scene?.weightFoot,
                ...
                scene?.weightDepth,
                scene?.weightRoi,
                scene?.weightTemporal,
                scene?.hipCenterXNorm,
                scene?.hipCenterYNorm,
                scene?.shoulderHipSpanNorm,
                scene?.torsoSpanNorm,
                scene?.bodyRoiHeightNorm,
                scene?.relativeScaleDistanceMeters,
                scene?.rejectedHipReason,
                scene?.heightSeedTrusted,
                scene?.bodyClipRisk,
                scene?.topEndpointConfidence,
                scene?.footEndpointConfidence,
                scene?.maskEndpointConfidence,
                scene?.experimentalHeightMeters,
                scene?.experimentalHeightSigmaMeters,
                scene?.experimentalHeightConfidence,
                scene?.experimentalHeightState,
                scene?.experimentalDistanceMeters,
                scene?.experimentalDistanceSigmaMeters,
                scene?.experimentalDistanceConfidence,
                scene?.experimentalSolverCost,
                scene?.experimentalSolverStatus,
                scene?.experimentalFactorSummary,
