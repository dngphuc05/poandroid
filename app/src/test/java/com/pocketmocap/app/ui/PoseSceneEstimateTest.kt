...
class PoseSceneEstimateTest {
    ...
    fun deriveOverlayPoseEstimateKeepsDepthPatchAsDebugOnly() {
        ...
        val far = deriveOverlayPoseEstimate(
            roi = roi,
            rawSubjectHeightMeters = near?.bodyHeightMeters ?: 1.80f,
            screenX = x,
            screenY = y,
            visibility = v,
            worldTracking = farTracking,
    ...
    private fun buildPoseLandmarks(): Triple<FloatArray, FloatArray, FloatArray> {
        ...
        // Shoulders + hips
        x[11] = 0.39f; y[11] = 0.41f
        x[12] = 0.51f; y[12] = 0.41f
        x[23] = 0.40f; y[23] = 0.58f
        x[24] = 0.50f; y[24] = 0.58f

        // Legs / feet
        x[25] = 0.39f; y[25] = 0.74f
        x[26] = 0.51f; y[26] = 0.74f
        x[27] = 0.36f; y[27] = 0.88f
        x[28] = 0.47f; y[28] = 0.88f
        x[29] = 0.35f; y[29] = 0.92f
        x[30] = 0.47f; y[30] = 0.92f
    ...
    private fun rawSceneMetric(
        ...
        SceneMetricSnapshot(
            ...
            floorPitchDegrees = 8f,
            lateralOffsetMeters = 0.05f,
            floorSource = "arcore_floor",
            rawHipDepthDistanceMeters = hipDepth,
            footPlaneDistanceMeters = footPlane,
            roiDistanceMeters = roiDistance,
            topRayHeightMeters = topRayHeight,
            pixelSpanHeightMeters = pixelSpanHeight,
            hipGeometryDistanceMeters = hipGeometryDistance,
            hipGeometryHeightMeters = hipGeometryHeight,
    ...
    private fun optimizerInput(
        ...
        PhysicalSceneOptimizerInput(
            ...
            rawCameraHeightMeters = 1.17f,
            rawHipDepthDistanceMeters = Float.NaN,
            footPlaneDistanceMeters = footDistance,
            roiDistanceMeters = roiDistance,
            topRayHeightMeters = topHeight,
            pixelSpanHeightMeters = pixelHeight,
            hipGeometryDistanceMeters = hipGeometryDistance,
            hipGeometryHeightMeters = hipGeometryHeight,
            torsoHeightMeters = torsoHeight,
            groundedFootDistanceMeters = groundedFootDistance,
